    ...
    <div class="container">
      <div id="video">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" type="text/html" src="ivideo-player.php?video=Motion Design&autostart=mute&controls=true&captions=false&color=FF7D00"></iframe>
        </div>
      </div>
    </div>
  </section>
